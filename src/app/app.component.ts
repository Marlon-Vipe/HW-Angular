...
@Component({  // Este componente envuelve a todos.
  ...
  imports: [RouterOutlet, UserComponent,TeamsComponent,NavBarComponent],  // Aqui es que se usa (se tiene que colocar cada componente a utilizar para que pueda tener acceso)
